    ...
    var divname = "name-field"
     ...
     showEmptyNameErrorname(field, id, divname)
      ...
      showEmptyNameErrorname(field, id, divname)
        ...
        else { var divname = "credit-card-field"
      ...
      showEmptyNameErrorname(field, id, divname)
        ...
        else { var divname = "expiration-field"
...
// expiration validation
    function validaexpiration(divname,expiration2) {
        ...
        var cdate = new Date();
            ...
            if(expiration2.length!=2){validexpiration= true}
            else {
            ...
            if ((mes>1) && (mes<=12)){ validexpiration= false
                document.getElementById(divname).classList.add("input-valid")
